...
async function main() {
  ...
  await server.register(swagger, {
    openapi: {
      info: { title: "HTS Classifier", description: "AI-powered Harmonized Tariff Schedule classifier", version: "0.1.0" },
    ...
    "/classify",
    {
      schema: {
        ...
        body: {
          ...
          properties: {
            description: { type: "string", example: "16 inch MacBook Pro laptop computer" },
            method: { type: "string", enum: ["embeddings", "gar", "agentic", "rerank"], default: "embeddings" },
            top_k: { type: "integer", default: 5, minimum: 1 },
            path_weight: { type: "number", minimum: 0, maximum: 1, nullable: true, description: "embeddings only: blend of leaf vs path score (0=leaf, 1=path, null=avg collection)" },
            candidate_pool: { type: "integer", minimum: 1, nullable: true, description: "rerank only: retrieval pool size before LLM rerank (default 20)" },
            beam_width: { type: "integer", minimum: 1, nullable: true, description: "agentic only: chapter selection width (default 3)" },
          },
        },
        response: {
          200: {
            ...
            properties: {
              ...
              intermediates: { type: "object", nullable: true, additionalProperties: true },
            },
          },
        },
      },
